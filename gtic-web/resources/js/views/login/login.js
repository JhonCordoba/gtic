...
document.getElementById("btn_login_in").addEventListener ("click", set_varibles_seguridad, false);
...
function guardarTokenAuthAPI() {
    ...
    axios.post('/api/auth/login', {
        ...
        .then((response) => {
            ...
            localStorage.setItem("token_auth_api", response.data.access_token);
